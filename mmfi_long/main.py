    ...
    for task in range(start_task, args.n_tasks):
        ...
        for epoch in range(n_epochs):
            for i, (x, y) in enumerate(train_loader):
                ...
                loss = agent.observe(inc_data,freeze_masks=freeze_masks,start_task=start_task)
                print(
        ...
        activation = compute_average_activation(agent.model, train_loader,device, task=task)
